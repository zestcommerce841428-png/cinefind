...
const STATIC_DESTINATIONS = [
  ...
  { label: "Your Taste Profile", href: "/account/taste-profile" },
  { label: "Yearly Recap", href: "/account/recap" },
  { label: "Box Office Leaderboard", href: "/box-office" },
  { label: "Cast Reunions", href: "/reunions" },
